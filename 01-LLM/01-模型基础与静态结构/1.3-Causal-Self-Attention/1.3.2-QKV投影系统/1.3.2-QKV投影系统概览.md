...
1. [[1.3.2.1-为什么需要QKV三种角色|为什么需要 Q、K、V 三种角色]] ✓
2. [[1.3.2.2-Query是什么|Query 是什么]] ✓
3. [[1.3.2.3-Key是什么|Key 是什么]] ✓
4. [[1.3.2.4-Value是什么|Value 是什么]] ✓
5. [[1.3.2.5-QKV怎样由线性投影产生|Q、K、V 怎样由线性投影产生]] ✓
