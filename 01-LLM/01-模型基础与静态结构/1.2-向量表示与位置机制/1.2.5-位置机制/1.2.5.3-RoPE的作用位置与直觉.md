...
parent: "[[1.2.5-位置机制概览]]"
previous: "[[1.2.5.2-Absolute-Position-Embedding]]"
next: "[[1.2.5.4-ALiBi的作用位置与直觉]]"
...
具体 Q、K、V 分工将在 `1.3 Causal Self-Attention` 中展开。
...
下一篇：[[1.2.5.4-ALiBi的作用位置与直觉|ALiBi 的作用位置与直觉]]。
