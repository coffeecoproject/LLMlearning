...
previous: "[[1.1.2.1-Vocabulary是什么]]"
next: "[[1.1.2.3-普通特殊与预留Token]]"
tags: [llm, token-id, vocabulary]
---

# 1.1.2.2 Token ID 是什么
...
完整 Decode 还可能涉及字节重组、空格恢复和特殊 Token 处理，因此不只是把肉眼看到的字符串机械拼接；具体流程见 [[1.1.5.7-Decode与文本恢复]]。
...
下一篇：[[1.1.2.3-普通特殊与预留Token|普通、特殊与预留 Token]]。
