...
parent: "[[00-Embedding基础机制概览|Embedding基础机制概览]]"
...
1. [[01-初始Token-Embedding|初始 Token Embedding]] ✓
2. [[02-Hidden-State是什么|Hidden State 是什么]] ✓
3. [[03-同一Token在不同上下文中的变化|同一 Token 在不同上下文中的变化]] ✓
4. [[04-表示在层与层之间怎样传递|表示在层与层之间怎样传递]] ✓
