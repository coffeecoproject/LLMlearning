...
previous: "[[00-Embedding框架速览概览|Embedding框架速览概览]]"
next: "[[00-向量基础概览|向量基础概览]]"
...
1. [[00-向量基础概览|向量基础]]：只补足理解向量、维度和序列表示所需知识；
2. [[00-Token-Embedding概览|Token Embedding]]：理解 Embedding Matrix 与 Lookup；
3. [[00-初始表示与Hidden-State概览|初始表示与 Hidden State]]：理解初始表示怎样被 Transformer 逐层更新。
