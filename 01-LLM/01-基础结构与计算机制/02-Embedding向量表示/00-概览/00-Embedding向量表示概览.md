...
previous: "[[00-Tokenizer文本离散化系统概览|Tokenizer文本离散化系统概览]]"
next: "[[00-Position位置机制概览|Position位置机制概览]]"
...
阅读：[[00-Embedding框架速览概览|Embedding 一页看懂]]。
...
进入：[[00-Embedding基础机制概览|Embedding 基础机制]]。

这里解释向量的最低必要知识、Embedding Matrix、Lookup，以及初始表示与 Hidden State 的关系。

### 继续深入

进入：[[00-Embedding参数与深入概览|Embedding 参数与深入]]。
...
- [x] [[00-Embedding框架速览概览|框架速览]]
- [x] [[00-Embedding基础机制概览|基础机制]]
- [x] [[00-Embedding参数与深入概览|参数与深入]]

框架路线下一站：[[01-Position框架速览|Position 一页看懂]]。
