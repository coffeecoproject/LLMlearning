...
previous: "[[00-FFN基础机制概览|FFN基础机制概览]]"
next: "[[02-FFN在Transformer-Block中的位置与关联|FFN在Transformer-Block中的位置与关联]]"
...
下一篇：[[02-FFN在Transformer-Block中的位置与关联|FFN 在 Transformer Block 中的位置与关联]]。
