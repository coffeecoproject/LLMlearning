...
parent: "[[00-Block参数与边界概览|Block参数与边界概览]]"
previous: "[[00-Block参数与边界概览|Block参数与边界概览]]"
next: "[[02-Hidden-State在训练与运行中的边界|Hidden-State在训练与运行中的边界]]"
...
下一篇：[[02-Hidden-State在训练与运行中的边界|Hidden State 在训练与运行中的边界]]。
