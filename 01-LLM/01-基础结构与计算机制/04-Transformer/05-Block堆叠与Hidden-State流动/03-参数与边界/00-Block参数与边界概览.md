...
previous: "[[05-Final-Hidden-State怎样交给输出层|Final-Hidden-State怎样交给输出层]]"
next: "[[01-num-hidden-layers与每层参数|num-hidden-layers与每层参数]]"
...
1. [[01-num-hidden-layers与每层参数|num_hidden_layers 与每层参数]]；
2. [[02-Hidden-State在训练与运行中的边界|Hidden State 在训练与运行中的边界]]；
3. [[03-怎样理解不同层的功能|怎样理解不同层的功能]]。
...
下一篇：[[01-num-hidden-layers与每层参数|num_hidden_layers 与每层参数]]。
