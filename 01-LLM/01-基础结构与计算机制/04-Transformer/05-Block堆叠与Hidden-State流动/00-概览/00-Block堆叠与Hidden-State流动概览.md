...
阅读：[[00-Block堆叠框架速览概览|Block 堆叠一页看懂]]。
...
进入：[[00-Block堆叠基础机制概览|Block 堆叠基础机制]]。

这里解释 Block 与 Layer、逐层 Hidden State、堆叠原因、主干形状以及最后一层输出。

### 继续深入

进入：[[00-Block参数与边界概览|Block 参数与边界]]。
...
- [x] [[00-Block堆叠框架速览概览|框架速览]]
- [x] [[00-Block堆叠基础机制概览|基础机制]]
- [x] [[00-Block参数与边界概览|参数与边界]]

框架路线下一站：[[00-Output-Layer输出层概览|Output Layer 输出层]]。
