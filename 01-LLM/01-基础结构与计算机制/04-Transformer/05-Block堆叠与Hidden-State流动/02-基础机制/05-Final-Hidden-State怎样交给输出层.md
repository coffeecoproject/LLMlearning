...
previous: "[[04-为什么主干形状通常保持不变|为什么主干形状通常保持不变]]"
next: "[[00-Block参数与边界概览|Block参数与边界概览]]"
...
基础机制完成。需要继续理解层数和参数时，进入 [[00-Block参数与边界概览|Block 参数与边界]]；否则可以进入 [[00-Output-Layer输出层概览|Output Layer]]。
