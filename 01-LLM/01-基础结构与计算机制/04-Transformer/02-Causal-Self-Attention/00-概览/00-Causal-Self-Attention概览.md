...
previous: "[[00-Transformer整体结构概览|Transformer整体结构概览]]"
...
阅读：[[00-Attention框架速览概览|Attention 一页看懂]]。
...
进入：[[00-Attention基础机制概览|Attention 基础机制]]。

这里完整连接 Q、K、V、Score、Mask、Weight、Context 和 Multi-Head Attention。

### 继续深入

进入：[[00-Attention扩展结构概览|Attention 扩展结构]]。
...
- [x] [[00-Attention框架速览概览|框架速览]]
- [x] [[00-Attention基础机制概览|基础机制]]
- [x] [[00-Attention扩展结构概览|扩展结构]]

框架路线下一站：[[00-Residual与Normalization框架速览概览|Residual 与 Normalization 一页看懂]]。
