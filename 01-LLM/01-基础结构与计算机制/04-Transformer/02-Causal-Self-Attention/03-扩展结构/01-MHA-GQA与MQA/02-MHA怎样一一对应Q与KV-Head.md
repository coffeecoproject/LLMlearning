...
previous: "[[01-为什么要区分Query-Head与KV-Head|为什么要区分Query-Head与KV-Head]]"
next: "[[03-MQA怎样让所有Query-Head共享KV|MQA怎样让所有Query-Head共享KV]]"
...
完整 Score、Weight、Context 和 `W_O` 已在[[00-Multi-Head-Attention概览|标准 Multi-Head Attention 专题]]讲过，本篇不重复计算。
...
下一篇：[[03-MQA怎样让所有Query-Head共享KV|MQA怎样让所有Query-Head共享KV]]。
