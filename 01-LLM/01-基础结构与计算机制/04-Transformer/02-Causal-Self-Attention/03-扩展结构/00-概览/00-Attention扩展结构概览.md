...
1. [[00-MHA-GQA与MQA概览|MHA、GQA 与 MQA]]：比较 Query Head 与 KV Head 怎样对应和共享；
2. [[00-MLA与注意力变体概览|MLA 与注意力变体]]：理解 DeepSeek-V2/V3 的低秩 KV 联合压缩与解耦 RoPE。
...
下一篇：[[00-MHA-GQA与MQA概览|MHA、GQA 与 MQA]]。
