...
next: "[[00-Transformer概览|Transformer概览]]"
...
阅读：[[01-Position框架速览|Position 一页看懂]]。
...
1. [[02-为什么必须表示顺序|为什么必须表示顺序]]；
2. [[03-三类位置机制对比|三类位置机制对比]]。
...
1. [[04-Absolute-Position-Embedding|Absolute Position Embedding]]；
2. [[05-RoPE的作用位置与直觉|RoPE 的作用位置与直觉]]；
3. [[06-ALiBi的作用位置与直觉|ALiBi 的作用位置与直觉]]。
...
框架路线下一站：[[01-Transformer框架速览|Transformer 一页看懂]]。
