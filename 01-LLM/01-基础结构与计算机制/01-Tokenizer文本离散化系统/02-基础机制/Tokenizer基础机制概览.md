...
1. [[Token概览|Token]]：模型处理的离散对象是什么；
2. [[Vocabulary与Token ID概览|Vocabulary 与 Token ID]]：有限词表怎样给 Token 分配索引；
3. [[Tokenizer处理流程概览|Tokenizer 处理流程]]：文本怎样经过预处理、切分、查表和输入整理。
