...
previous: "[[03-Token可能对应哪些文本单位|Token可能对应哪些文本单位]]"
next: "[[01-Vocabulary是什么|Vocabulary是什么]]"
...
1. [[01-Vocabulary是什么|Vocabulary 是什么]]：为什么词表必须有限？
2. [[02-Token-ID是什么|Token ID 是什么]]：编号有什么意义，又没有什么意义？
3. [[03-普通特殊与预留Token|普通、特殊与预留 Token]]：词表中为什么不只有文本片段？
4. [[04-词表怎样连接模型输入与输出|词表怎样连接模型输入与输出]]：同一编号体系怎样连接输入行和输出候选？
5. [[05-词表大小配置与兼容性|词表大小、配置与兼容性]]：为什么 Tokenizer 必须和模型配套？
