...
previous: "[[03-Pre-tokenization|Pre-tokenization]]"
next: "[[05-Special-Token与Post-processing|Special-Token与Post-processing]]"
...
新输入 `苹 | 果 | 汁` 按固定优先级合并为 `苹果汁`。这里不重新训练规则，详见 [[02-BPE|BPE]]。
...
下一篇：[[05-Special-Token与Post-processing|Special Token 与 Post-processing]]。
