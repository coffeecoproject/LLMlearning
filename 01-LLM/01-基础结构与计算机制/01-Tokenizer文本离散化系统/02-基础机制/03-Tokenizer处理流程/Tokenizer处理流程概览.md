...
3. [[Pre-tokenization|Pre-tokenization]]
4. [[Tokenization-Model|Tokenization Model]]
5. [[Special-Token与Post-processing|Special Token 与 Post-processing]]
6. [[Vocabulary-Lookup与输入整理边界|Vocabulary Lookup 与输入整理边界]]
7. [[Decode与文本恢复|Decode 与文本恢复]]
8. [[可逆性与边界|可逆性与边界]]
