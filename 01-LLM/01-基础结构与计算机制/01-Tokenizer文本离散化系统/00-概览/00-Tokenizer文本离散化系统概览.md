...
阅读：[[00-Tokenizer框架速览概览|Tokenizer 一页看懂]]。
...
进入：[[00-Tokenizer基础机制概览|Tokenizer 基础机制]]。

这里解释 Token、Vocabulary、Token ID 和完整编码/解码流程。

### 继续深入

进入：[[00-Tokenizer方法与深入概览|Tokenizer 方法与深入]]。
...
- [x] [[00-Tokenizer框架速览概览|框架速览]]
- [x] [[00-Tokenizer基础机制概览|基础机制]]
- [x] [[00-Tokenizer方法与深入概览|方法与深入]]
- [x] [[00-工具与实现概览|工具与实现]]
- [x] [[00-影响与边界概览|影响与复习]]

框架路线下一站：[[00-Embedding框架速览概览|Embedding 一页看懂]]。
